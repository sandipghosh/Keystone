...
namespace Keystone.Web.Utilities.Expression
{
    ...
    public class ExpressionSerializationTypeResolver
    {
        ...
        /// <summary>
        /// Resolves the type of the string from.
        /// </summary>
        ...
        /// <exception cref="System.ArgumentException">Could not find a matching type</exception>
        ...
        /// <param name="genArgTypes">The gen arg types.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Gets the or create anonymous type for.
        /// </summary>
        /// <param name="name">The name.</param>
        /// <param name="properties">The properties.</param>
        /// <param name="ctr_params">The ctr_params.</param>
        /// <returns></returns>
