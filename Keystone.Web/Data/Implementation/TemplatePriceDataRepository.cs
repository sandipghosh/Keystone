...
namespace Keystone.Web.Data.Implementation
{
    ...
    public class TemplatePriceDataRepository
        : DataRepository<TemplatePrice, TemplatePriceModel>, ITemplatePriceDataRepository
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplatePriceDataRepository"/> class.
        /// </summary>
        /// <param name="unitOfWork">The unit of work.</param>
        public TemplatePriceDataRepository(UnitOfWork<KeystoneDBEntities> unitOfWork)
            : base(unitOfWork)
        {
